...
<head>
    <meta charset="UTF-8">
    <title>CONTACT US INDO BALI TOUR</title>
    ...
    <link rel="stylesheet" href="contact/css/contactus.css">
</head>
<body>
    <nav>
    ...
    <div class="container-cu">
        <img src="contact/image/pantai karang sanur.jpg">
        <h1 class="desk-cu">contact us</h1>
        <ul class="links">
    ...
    <div>
        <h1 class="desk1">apa yang bisa kami bantu?</h1>
    </div>
    ...
    <section>
        <div class="contact-container">
            <div class="question-container">
                <div class="question">
                    <button class="btn-1">
                        <span>nomor for call center</span>
                        <span><i class='bx bx-chevron-down d-arrow'></i></span>
                    </button>
                    <p class="p-1">
                        Phone/Whatsapp : 082144678456
                    </p>
                </div>
    
                <div class="question">
                    <button class="btn-2">
                        <span>email for call center</span>
                        <span><i class='bx bx-chevron-down d-arrow'></i></span>
                    </button>
                    <p class="p-2">
                        enjoy@indobalitour.com
                    </p>
                </div>
...
<!-- -------------------------------------------------------------------------------------------------------------------- -->
            <div class="form-container">
                <form action="https://api.web3forms.com/submit" method="POST" class="contact-right">
                    ...
                    <input type="hidden" name="access_key" value="d66f2b98-4ffb-4c59-956d-6494c5f3e1a9">
