...
<body>
    ...
    <div class="container-adv">
        <img src="image projek PKL/package 3 day.jpg">
...
<!-- =========================================================================     -->
    ...
    <div class="container-loc">
        <div class="lock">
            ...
            <img src="image projek PKL/pantai karang sanur.jpg" alt="">
            <img src="image projek PKL/jeep tour.jpg" alt="">
            <img src="image projek PKL/bali sea walker.jpg" alt="">
            <img src="image projek PKL/gwk.jpg" alt="">
            <img src="image projek PKL/kecak.jpeg" alt="">
        </div>
    </div> 
    ...
    <div class="container-coll">
        ...
        <div class="container-transport">
            <div class="img-container">
                <img src="image projek PKL/avvanza.png" alt="">
                <img src="image projek PKL/toyota hiace.png" alt="">
                <img src="image projek PKL/toyota.png" alt="">
                <img src="image projek PKL/suzuki.png" alt="">
                <img src="image projek PKL/daihatsu.png" alt="">
                <img src="image projek PKL/innova.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="content-all">
        <div class="card">
            <div class="content">
                <a href="#"><img src="image projek PKL/package 6 day.jpg" alt="" ></a>
                <a href="#"><h2>Packages 6 Day Tour</h2></a>
            </div>
        </div>
        <div class="card">
            <div class="content">
                <a href="#"><img src="image projek PKL/package 5 day.jpg" alt="" ></a>
                <a href="#"><h2>Packages 5 Day Tour</h2></a>
            </div>
        </div>        
    </div>
