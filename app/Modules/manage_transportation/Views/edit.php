...
<form action="/backoffice/transportation/update/<?= $transport['id']; ?>" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col">
            <div class="mb-3">
                ...
                <?php if (session('validation')) {
                    ...
                    echo '';
                } ?>" id="brand" value="<?= old('brand', $transport['brand']); ?>" aria-describedby="brandcheck">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <div class="input-group mb-3">
                ...
                <?php if (session('validation')) {
                    ...
                    echo '';
                } ?>" aria-describedby="capacitycheck" name="capacity" value="<?= old('capacity', $transport['capacity']); ?>">
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <?php if (session('validation')) {
                    ...
                    echo '';
                } ?>" value="<?= old('fee', $transport['fee']); ?>" id="fee" aria-describedby="feecheck">
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <input type="text" name="slug" class="form-control" placeholder="indobalitour.com/transportation/<?= $transport['slug']; ?>" id="slug" disabled>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="extra" name="extra" rows="3"><?= $transport['extra']; ?></textarea>
