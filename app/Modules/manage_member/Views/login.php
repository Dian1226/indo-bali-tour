...
<form action="/backoffice/faq/update/<?= $faq['id']; ?>" method="post">
    <div class="row">
        <div class="col">
            <div class="mb-3">
                ...
                <?php if (session('validation')) {
                    ...
                    echo '';
                } ?>" id="question" value="<?= old('question', $faq['question']); ?>" aria-describedby="questioncheck">
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <?php if (session('validation')) {
                    ...
                    echo '';
                } ?>" value="<?= old('answer', $faq['answer']); ?>" id="answer" aria-describedby="answercheck">
