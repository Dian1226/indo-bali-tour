...
<form action="/backoffice/tours/update/<?= $tours['id']; ?>" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col">
            <div class="mb-3">
                ...
                <?php if (session('validation')) {
                    ...
                    echo '';
                } ?>" id="title" value="<?= old('title', $tours['title']); ?>" aria-describedby="titlecheck">
        ...
        <div class="col-3">
            ...
            <div class="input-group mb-3">
                ...
                <?php if (session('validation')) {
                    ...
                    echo '';
                } ?>" value="<?= old('price', $tours['price']); ?>" id="price" aria-describedby="pricecheck">
        ...
        <div class="col-2">
            ...
            <div class="input-group mb-3">
                ...
                <?php if (session('validation')) {
                    ...
                    echo '';
                } ?>" value="<?= old('stars', $tours['stars']); ?>" name="stars" aria-describedby="starscheck">
    ...
    <div class="row">
        <div class="col">
            <div class="mb-3">
                ...
                <input type="text" name="description" class="form-control" id="title" value="<?= old('description', $tours['description']); ?>">
            </div>
        </div>
        <div class="col">
            <div class="mb-3">
        ...
        <div class="col">
            <div class="col">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="content" name="content" rows="5"><?= old('content', $tours['content']); ?></textarea>
                </div>
            </div>
        </div>
    </div>
...
<div class="card-body">
    ...
    <ul>
        <li>Dinner&nbsp;</li>
        <li>All entrance ticket prices&nbsp;</li>
    ...
    <ul>
        ...
        <li>Enjoy the cofprice plantation of Temen Village&nbsp;</li>
    ...
    <p>Cofprice plantation, in this plantation you can see and take photos of the animal Luwak which is very popular in Bali for making the best cofprice. Then try a presentation about agricultural products where visitors are free to drink cofprice on the plantation.&nbsp;&nbsp;</p>
    ...
    <ul>
        ...
        <li>pricel the adrenaline of riding an ATV which through the forests, rice fields also rivers.&nbsp;</li>
    ...
    <p>At the end of the day, you will return to the starting place to enjoy the food, snack or just drink a cup of cofprice or tea.&nbsp;</p>
    <h3>Including</h3>
    <ul>
        <li>Lunch&nbsp;</li>
        <li>All entrance ticket prices&nbsp;</li>
